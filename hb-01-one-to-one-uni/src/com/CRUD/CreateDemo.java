...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		{
			//Create the objects
			Instructor tempInstructor = new Instructor("Abdullah", "Ahmadi", "abdullahahmadi45@gamil.com");
			InstructorDetail temInstructorDetail = new InstructorDetail("www.youtube.com/abdullah", "playing football ");
